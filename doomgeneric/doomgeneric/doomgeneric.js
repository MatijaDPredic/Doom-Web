...
// include: C:\Users\Matija\AppData\Local\Temp\tmpa2prpq55.js
  ...
  (() => {
    ...
    loadPackage({"files": [{"filename": "/freedoom1.wad", "start": 0, "end": 28795076}], "remote_package_size": 28795076});

  })();

// end include: C:\Users\Matija\AppData\Local\Temp\tmpa2prpq55.js
// include: C:\Users\Matija\AppData\Local\Temp\tmpeg9_rukc.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Matija\AppData\Local\Temp\tmpeg9_rukc.js
// include: C:\Users\Matija\AppData\Local\Temp\tmpu9zi43ce.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Matija\AppData\Local\Temp\tmpu9zi43ce.js
...
var _DG_GetHUDState = Module['_DG_GetHUDState'] = makeInvalidEarlyAccess('_DG_GetHUDState');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['DG_GetHUDState'] != 'undefined', 'missing Wasm export: DG_GetHUDState');
  ...
  _DG_GetHUDState = Module['_DG_GetHUDState'] = createExportWrapper('DG_GetHUDState', 1);
